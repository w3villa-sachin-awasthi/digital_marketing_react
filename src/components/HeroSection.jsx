...
function HeroSection() {
    return (
        <div className='flex lg:flex-row flex-col  md:mt-[100px] lg-mt-[140px] mt-[50px]  w-[100%] font-medium bg-slate-50 px-[20px]'>
            <div className="md:w-[50%] sm:w-[70%] w-[90%] mt-10">
                ...
                <h3 className='flex text-[28px] mt-[20px] font-normal '> <AiFillCaretDown className='text-orange-700 rounded-[50%] text-[50px] shadow-lg shadow-slate-300 px-[10px] py-[7px] mr-6' /> Explore more</h3>
            </div>
